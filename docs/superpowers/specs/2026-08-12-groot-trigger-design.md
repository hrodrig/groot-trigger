# groot-trigger — design (2026-08-12)

**Status:** Approved → canonical contract is [`docs/SPECIFICATIONS.md`](../../SPECIFICATIONS.md).  
**Repo:** local `groot-trigger` (GitHub remote deferred).  
**Not in scope:** GROOT CLI; Helm CronJob packaging (**groot** / **groot-selfhosted**).
...
## 14. Implementation order (after spec approval)
